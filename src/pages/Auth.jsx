...
import {
  Eye, EyeOff, Mail, Lock, User, Phone, ArrowRight, CheckCircle2, Sparkles,
} from 'lucide-react'
...
function LoginPane({ id = 'login' }) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label className={labelClass} style={labelStyle} htmlFor={`${id}-email`}>
          Email Address
        </label>
      ...
      <div className="mb-3">
        <label className={labelClass} style={labelStyle} htmlFor={`${id}-password`}>
          Password
        </label>
        <div className="relative">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <a
          href="#"
          className="text-[12px] hover:text-gold transition-colors"
      ...
      <button
        type="submit"
        className="w-full inline-flex items-center justify-center gap-2 py-3.5 rounded-full text-xs tracking-[0.18em] uppercase font-semibold transition-all duration-300 cursor-pointer hover:-translate-y-0.5 shadow-lg hover:shadow-gold/20"
        style={{
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-[10px] tracking-[0.25em] uppercase" style={{ color: 'var(--color-ivory-muted)' }}>
          or continue with
        </span>
        <div className="flex-1 h-px" style={{ background: 'rgba(201, 169, 110, 0.15)' }} />
      </div>
...
function RegisterPane({ id = 'register' }) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label className={labelClass} style={labelStyle} htmlFor={`${id}-name`}>
          Full Name
        </label>
        <div className="relative">
      ...
      <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className={labelClass} style={labelStyle} htmlFor={`${id}-phone`}>
            Phone
          </label>
          <div className="relative">
      ...
      <div className="mb-5">
        ...
        <p className="text-[11px] mt-1.5" style={{ color: 'rgba(245, 240, 232, 0.4)' }}>
          Minimum 8 characters
        </p>
      </div>

      <label
        className="flex items-start gap-2.5 mb-5 text-[12px] cursor-pointer"
        style={{ color: 'var(--color-ivory-muted)' }}
      >
        <input
          type="checkbox"
        ...
        <span>
          I agree to the{' '}
          <a href="/terms" className="hover:underline" style={{ color: 'var(--color-gold)' }}>
            Terms of Service
          </a>{' '}
